...
The ConnectBox is a media sharing device with built-in Wifi access point using
small form-factor computers like the Raspberry Pi. This site demonstrates the
current ConnectBox client interface, as it would be seen if it were deployed
on a Raspberry Pi using the ConnectBox Sample Content. This site is
 automatically updated to show the most recent revision of the client
 interface from https://github.com/ConnectBox/connectbox-pi
